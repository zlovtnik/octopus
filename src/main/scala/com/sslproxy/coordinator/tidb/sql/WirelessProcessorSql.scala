    ...
    def security: ConnectionIO[Int] =
      sql"""INSERT INTO wireless_frame_security (
             ...
             SELECT e.dedupe_key, e.large_frame, e.mixed_encryption, e.dedupe_or_replay_suspect,
                    e.raw_len, e.security_flags, e.risk_score, COALESCE(e.tags, JSON_ARRAY()),
    ...
    val devices =
      sql"""INSERT INTO devices (
             ...
             ON DUPLICATE KEY UPDATE
               ...
               username = COALESCE(VALUES(username), devices.username),
               hostname = COALESCE(VALUES(hostname), devices.hostname),
